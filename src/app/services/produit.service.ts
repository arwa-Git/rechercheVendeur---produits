...
import { Image } from '../model/image.model'; // Import the Image model
...
export class ProduitService {
  ...
  ajouterProduit(prod: Produit) // : Observable<Produit>   (ajouter ça pour spring boot)
 ...
 // code de supprimerProduit avec spring boot ( supprimerProduit(id: number): Observable<void> {
  ...
  consulterProduit(category: string): Produit {
